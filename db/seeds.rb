...
comment1 = Comment.create(body: "This was so helpful!", student_id: 2, post_id: post1.id)
comment2 = Comment.create(body: "I am trying my best not to get tricked by the sneaky e!", student_id: 1, post_id: post2.id)
comment3 = Comment.create(body: "Annotating is difficult but I'm going to keep trying my best.", student_id: 3, post_id: post3.id)
